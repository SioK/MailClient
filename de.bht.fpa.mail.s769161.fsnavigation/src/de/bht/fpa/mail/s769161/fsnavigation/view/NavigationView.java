...
public class NavigationView extends ViewPart implements Observer,
	...
	public void createPartControl(Composite parent) {
		...
		FileSystemManager.getInstance().addBaseDirObserver(this);
		...
		viewer.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				selDir = SelectionHelper.handleStructuredSelectionEvent(event,
						DirectoryItem.class);
				if (selDir != null) {
					String statusMsg = STATUS_LINE_OPENED_DIRECTORY_PREFIX
							+ selDir.getName();
	...
	public DirectoryItem getBaseDirectory() {
		return new DirectoryItem(new File(FileSystemManager.getInstance()
