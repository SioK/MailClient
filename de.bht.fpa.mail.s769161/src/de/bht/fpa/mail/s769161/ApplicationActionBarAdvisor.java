...
import de.bht.fpa.mail.s769161.imapnavigation.action.SynchronizeImapFolderAction;
...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
  ...
  protected void fillMenuBar(IMenuManager menuBar) {
    ...
    MenuManager mailBox = new MenuManager("&Mailbox", null);
    ...
    mailBox.add(synchronizeImapFolderAction);
